...
bool kinect::img_to(cv::Mat& o) {
	return kinect_.prochaine_image(o);
}

kinect::kinect_device::kinect_device(freenect_context* ctx, int i) : Freenect::FreenectDevice(ctx, i), dipah_(cv::Size(640,480), CV_16UC1), img_(cv::Size(640,480), CV_8UC3) {}
...
bool kinect::kinect_device::prochaine_image(cv::Mat& out) {
	m2_.lock();
	if(nouvelle_image_) {
